...
# API_URL = "https://button.pythonanywhere.com/api/upload_detection/"  #12.14 new add
...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        # 初始化检测状态
        detected = [0 for _ in range(len(names))]  # 初始化检测状态
        ...
        for i, det in enumerate(pred):  # per image
            ...
            # 调用 ChangeDetection 的 add 方法，保存和处理状态变化
